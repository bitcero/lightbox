...
class RMLightbox
{
    ...
    public function __construct()
    {
        ...
        RMTemplate::get()->add_style($css . '/colorbox.css', 'rmcommon', [ 'directory' => 'plugins/lightbox' ]);
    ...
    public function render()
    {
        ...
        RMTemplate::getInstance()->add_script('jquery.colorbox-min.js', 'rmcommon', [ 'directory' => 'plugins/lightbox' ]);
